...
const seedData = async () => {
    try {
        ...
        const savedVehicles = await Vehicle_1.default.create(vehiclesData);
        console.log(`Seeded ${savedVehicles.length} vehicles.`);
        // Helper to find vehicle by name
        const getVehId = (name) => savedVehicles.find(v => v.name === name)?._id;
        ...
        const savedMaintenance = await Maintenance_1.default.create(maintenanceData);
        ...
        await Activity_1.default.create(activitiesData);
        ...
        await Alert_1.default.create(alertsData);
