    ...
    <div className="p-8 space-y-6 animate-fade-in">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-[#5bc0be] text-[#0b132b] font-bold px-4 py-2.5 rounded-xl hover:bg-[#48a9a7] hover:scale-105 transition-all flex items-center gap-2 cursor-pointer"
        >
